					...
					<div class='codeless_custom_menu_options'>
						...
						<p class="description description-wide codeless_checkbox codeless_custom_mega_menu codeless_custom_mega_menu_d0">
							...
							<label for="edit-<?php echo $key.'-'.$item_id; ?>">
								...
								<input type="checkbox" value="active" id="edit-<?php echo $key.'-'.$item_id; ?>" class=" <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" <?php echo $value; ?> /><?php _e( $title, 'codeless' ); ?>
						...
						<p class="description description-wide codeless_background_image codeless_custom_mega_menu codeless_custom_mega_menu_d1">
							...
							<label for="edit-<?php echo $key.'-'.$item_id; ?>">
								...
								<input type="text" id="edit-<?php echo $key.'-'.$item_id; ?>" class=" <?php echo $key; ?>" name="<?php echo $key . "[". $item_id ."]";?>" value="<?php echo $value; ?>" /><?php _e( $title, 'codeless' ); ?>
